...
public class DingdanwanchengEntity<T> implements Serializable {
	 ...
	 * 设置：投放位置
	 */
	public void setToufangweizhi(String toufangweizhi) {
		this.toufangweizhi = toufangweizhi;
	}
	/**
	 * 获取：投放位置
	 */
	public String getToufangweizhi() {
		return toufangweizhi;
	}
	/**
	 * 设置：订单状态
	 */
