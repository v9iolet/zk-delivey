			...
			<div class="usersBox updateInfo" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="24">
							<el-form-item prop="yingyezhizhao" label="营业执照">
								<uploads
									...
									:fileUrls="userForm.yingyezhizhao?userForm.yingyezhizhao:''" 
									@change="yingyezhizhaoUploadSuccess">
								</uploads>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="gongsizhanghao" label="公司账号">
								<el-input class="list_inp" v-model="userForm.gongsizhanghao" placeholder="公司账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="gongsimingcheng" label="公司名称">
								<el-input class="list_inp" v-model="userForm.gongsimingcheng" placeholder="公司名称" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="gongsidizhi" label="公司地址">
								<el-input class="list_inp" v-model="userForm.gongsidizhi" placeholder="公司地址" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="gongsirenshu" label="公司人数">
								<el-input class="list_inp" v-model="userForm.gongsirenshu" placeholder="公司人数" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.gongsizhanghao)
		...
		userFormRef.value.validate((valid)=>{
			if(valid){
				if(userForm.value.yingyezhizhao!=null){
					userForm.value.yingyezhizhao = userForm.value.yingyezhizhao.replace(new RegExp(context?.$config.url,"g"),"");
				}
				store.dispatch('user/update',userForm.value).then(res=>{
					if(res?.data&&res.data.code==0){
						context?.$toolUtil.message('更新成功','success')
