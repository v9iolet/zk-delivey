			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="服务详情" prop="fuwuxiangqing">
						<editor class="list_editor" :value="form.fuwuxiangqing" placeholder="请输入服务详情" :readonly="!isAdd||disabledForm.fuwuxiangqing?true:false"
							@change="(e)=>editorChange(e,'fuwuxiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.fuwuxiangqing = res.data.data.fuwuxiangqing.replace(reg,'../../../cl1006354156/file');
