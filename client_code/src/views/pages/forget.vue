	...
	<div>
		<div class="forget_view">
			<el-form :model="forgetForm" class="forget_box">
				<div class="forget_title">基于springboot的湛科校园包裹代取服务平台{{pageType==1?'输入账号':pageType==2?'输入密保':'重置密码'}}</div>
				<div class="tab_view">
...
<style lang="scss" scoped>
	.forget_view {
        background-image: url("http://clfile.zggen.cn/20250104/aef88320f8c4498b9d1853bbd00d7f67.webp")!important;
		// 表单盒子
		.forget_box {
			// 标题
			.forget_title {
...
.forget_view .forget_box .list_item{display: flex;align-items: center;width: 80%;justify-content: flex-start;margin: 0px 0px 30px;background: #fff;border-radius: 8px;}
