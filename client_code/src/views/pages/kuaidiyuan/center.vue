			...
			<div class="usersBox updateInfo" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						...
						<el-col :span="12">
							<el-form-item prop="kuaidiyuanzhanghao" label="快递员账号">
								<el-input class="list_inp" v-model="userForm.kuaidiyuanzhanghao" placeholder="快递员账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="kuaidiyuanxingming" label="快递员姓名">
								<el-input class="list_inp" v-model="userForm.kuaidiyuanxingming" placeholder="快递员姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="gongsizhanghao" label="公司账号">
								<el-input class="list_inp" v-model="userForm.gongsizhanghao" placeholder="公司账号" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="gongsimingcheng" label="所属公司">
								<el-input class="list_inp" v-model="userForm.gongsimingcheng" placeholder="所属公司" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.kuaidiyuanzhanghao)
