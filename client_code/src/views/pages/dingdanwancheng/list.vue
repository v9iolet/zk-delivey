			...
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="服务类型" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.fuwuleixing}}
							</template>
						</el-table-column>
						<el-table-column label="服务价格" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.fuwujiage}}
							</template>
						</el-table-column>
						...
						<el-table-column label="下单账号" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.xiadanzhanghao}}
							</template>
						</el-table-column>
						<el-table-column label="下单人" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.xiadanren}}
							</template>
						</el-table-column>
						...
						<el-table-column label="货物名称" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="收货地址" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.shouhuodizhi}}
							</template>
						</el-table-column>
						<el-table-column label="收件人姓名" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="完成时间" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="投放位置" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.toufangweizhi}}
							</template>
						</el-table-column>
						<el-table-column label="订单状态" :resizable='true' align="left" header-align="left">
							<template #default="scope">
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/dingdanwanchengAdd')
	}
	//判断是否从个人中心跳转
