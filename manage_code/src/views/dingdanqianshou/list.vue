	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('dingdanqianshou','新增')">
						新增
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('dingdanqianshou','删除')">
						删除
					</el-button>
				</div>
			</div>
			<el-table
				...
				ref="table"
				v-if="btnAuth('dingdanqianshou','查看')"
				:data="list"
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('dingdanqianshou','查看')" @click="infoClick(scope.row.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('dingdanqianshou','修改')">
							修改						</el-button>
...
<script setup>
	...
	import shensuxinxiFormModel from '@/views/shensuxinxi/formModel'
	const shensuxinxiFormModelRef = ref(null)
    const shensuxinxiCrossAddOrUpdateHandler = (row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue) => {
