	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('shensuxinxi','新增')">
						新增
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('shensuxinxi','删除')">
						删除
					</el-button>
				</div>
			</div>
			<el-table
				...
				<el-table-column label="审核" v-if="btnAuth('shensuxinxi','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button v-if="scope.row.sfsh!='是'" size="small" @click="approvalClick(scope.row)">回复</el-button>
					</template>
				</el-table-column>
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('shensuxinxi','查看')" @click="infoClick(scope.row.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('shensuxinxi','修改')">
							修改						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('shensuxinxi','删除')">
							删除						</el-button>
					</template>
				</el-table-column>
			</el-table>
...
<script setup>
	...
	const approvalClick = (row) => {
		let params = {
			...
			qianshoushijian: row.qianshoushijian,
			wenti: row.wenti,
			shhf: row.shhf,
		}
		nextTick(() => {
